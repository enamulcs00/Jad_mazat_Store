...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: "store",
                loadChildren: () => Promise.all(/*! import() | pages-store-store-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-store-store-module")]).then(__webpack_require__.bind(null, /*! ./pages/store/store.module */ "./src/app/cooldash/pages/store/store.module.ts")).then(m => m.StoreModule)
            },
