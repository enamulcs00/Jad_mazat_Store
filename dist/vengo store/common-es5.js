(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppCooldashServicesPopupPopupServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _pages_store_category_storeCategoryModal_storeCategoryModal_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../pages/store/category/storeCategoryModal/storeCategoryModal.component */
    "./src/app/cooldash/pages/store/category/storeCategoryModal/storeCategoryModal.component.ts");
    /* harmony import */


    var _pages_store_store_storeOutletModal_storeOutletModal_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../../pages/store/store/storeOutletModal/storeOutletModal.component */
    "./src/app/cooldash/pages/store/store/storeOutletModal/storeOutletModal.component.ts");
    /* harmony import */


    var _pages_store_store_food_type_store_type_modal_store_type_modal_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../../pages/store/store/food-type/store-type-modal/store-type-modal.component */
    "./src/app/cooldash/pages/store/store/food-type/store-type-modal/store-type-modal.component.ts");
    /* harmony import */


    var _pages_store_order_accept_modal_accept_modal_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../../pages/store/order/accept-modal/accept-modal.component */
    "./src/app/cooldash/pages/store/order/accept-modal/accept-modal.component.ts");
    /* harmony import */


    var src_app_forgot_password_modal_forgot_password_modal_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    let PopupService = class PopupService {
      ...
      forgotPasswordsendEmail() {
        const dialogRef = this.dialog.open(src_app_forgot_password_modal_forgot_password_modal_component__WEBPACK_IMPORTED_MODULE_7__["ForgotPasswordModalComponent"]);
        return dialogRef.afterClosed();
      }
